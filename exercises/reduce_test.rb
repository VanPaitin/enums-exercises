...
class ReduceTest < Minitest::Test
  ...
  def test_capitalize_keywords_in_phrase_one_fish_two_fish_red_fish_blue_fish
    ...
    # Your code goes here
    result = keywords.reduce('one fish two fish red fish blue fish') do |memo, elem|
      memo.gsub(elem, &:upcase)
    end
  ...
  def test_divide_560_by_a_bunch_of_numbers
    ...
    result = numbers.reduce(560) do |memo, element|
      memo / element
    end
    # Your code goes here
  ...
  def test_subtract_smallest_values_from_100
    ...
    result = elements.reduce(100) do |memo, element|
      memo - element.min
    end
    # Your code goes here
  ...
  def test_add_all_the_second_values_together
    ...
    result = elements.reduce(0) do |memo, elem|
      memo + elem.last
    end
    # initial value is 0
    # Your code goes here
